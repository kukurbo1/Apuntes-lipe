...
\begin{definition}
  ...
  \begin{itemize}
    \item Decimos que $a \in R$ es \wea{máximo común divisor de $S$} (abreviado como \wea{gcd}) si $\forall b \in R$ 
...
\begin{example}
  $d$ es gcd de $\{a,b\}$ si y solo si $(a) + (b) = (d)$. $m$ es lcm de $\{a,b\}$ si y solo si $(m) = (a) \cap (b)$.
\end{example} %% demostrar
