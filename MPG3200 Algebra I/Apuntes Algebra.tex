...
\newpage
% Aquí pondré todas las equivalencias raras de tipos de anillos
\begin{theorem}
  Tenemos las siguientes equivalencias de anillos:
  \begin{itemize}
    \item DE $\implies$ DIP $\implies$ DFU $\implies$ DI.
    \item Hay DFUs no Noetherianos y hay Noetherianos no DFU.
  \end{itemize}
\end{theorem}
